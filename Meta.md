...
<!-- GVW: second sentence in para below seems redundant (?) -->
...
<!-- GVW: maybe a hint about what the "en" in "enexpr" stands for -->
...
<!-- GVW: I like the operator precedence mention above -->
...
<!-- GVW: in the above, is weird variable names the main reason for using this trick? seems to imply that it is (but maybe that's just me) -->
...
These techniques become yet more powerful when combined with functional programming. You'll explore these ideas in detail in Section \@ref(expr-case-studies) but the teaser below shows how you might generate a complex model specification from simple inputs.

<!-- GVW: I read this teaser twice and still don't know what it's showing me - I can probably figure it out, but I think a lot of readers will be as baffled as I am -->
...
<!-- GVW: I'd say "waht the symbols in the tree mean" and skip that they're leaf nodes for now -->
...
<!-- GVW: insert parenthetical comment after "pitfalls" to say which section will cover them -->
...
<!-- GVW: explain the difference between actual and desired output here, just to be sure readers understand the problem -->
