...
\begin{center}\includegraphics{screenshots/debugging/rstudio-error} \end{center}
...
\begin{center}\includegraphics{screenshots/debugging/rstudio-traceback} \end{center}
