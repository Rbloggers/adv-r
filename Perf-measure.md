...
#> 1 sqrt(x)    592.09ns 802.3ns 683.01ns  37.2µs  1246377.      848B
#> 2 x^0.5        8.99µs  10.2µs   9.44µs 756.1µs    98306.      848B
...
#> 1 sqrt(x)    592.09ns 683.01ns  1246377.     0
#> 2 x^0.5        8.99µs   9.44µs    98306.     0
```
