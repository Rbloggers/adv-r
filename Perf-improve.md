...
#> 1 mean1(x)      227µs    236µs     4216.     0
#> 2 mean2(x)      112µs    114µs     8395.     0
```
...
#>   expression           min   median `itr/sec`  n_gc
#>   <chr>           <bch:tm> <bch:tm>     <dbl> <dbl>
#> 1 mean(x)           2.61µs      3µs   297912.     1
#> 2 mean.default(x)   1.22µs    1.4µs   639699.     0
```
...
#>   expression              min   median `itr/sec`  n_gc
#>   <chr>              <bch:tm> <bch:tm>     <dbl> <dbl>
#> 1 mean(x)               2.6µs   2.98µs   293179.     1
#> 2 mean.default(x)      1.22µs   1.43µs   618873.     0
#> 3 .Internal(mean(x)) 340.98ns 356.93ns  2505741.     0
```
...
#>   expression              min   median `itr/sec`  n_gc
#>   <chr>              <bch:tm> <bch:tm>     <dbl> <dbl>
#> 1 mean(x)              24.8µs   25.2µs    38324.     1
#> 2 mean.default(x)      23.4µs   23.6µs    40954.     0
#> 3 .Internal(mean(x))   22.4µs   22.4µs    43474.     0
```
...
#>   expression         min   median `itr/sec`  n_gc
#>   <chr>         <bch:tm> <bch:tm>     <dbl> <dbl>
#> 1 as.data.frame   1.05ms   1.11ms      874.     7
#> 2 quick_df        6.14µs   7.19µs   124317.     2
```
...
#>   expression        min   median `itr/sec`  n_gc
#>   <chr>        <bch:tm> <bch:tm>     <dbl> <dbl>
#> 1 lookup[x1]   518.05ns 630.04ns  1260315.     0
#> 2 lookup[x10]    1.55µs   1.71µs   502616.     1
#> 3 lookup[x100]   4.21µs    4.8µs   190540.     0
```
...
#>   expression      min   median `itr/sec`  n_gc
#>   <chr>      <bch:tm> <bch:tm>     <dbl> <dbl>
#> 1 loop10      19.65µs  21.89µs    43224.     3
#> 2 loop100    805.56µs 829.48µs     1195.     2
#> 3 vec10        4.89µs   5.12µs   185903.     0
#> 4 vec100      39.15µs   40.2µs    23660.     0
```
