...
#>   <chr>      <bch:tm> <bch:t> <bch:> <bch:t>     <dbl> <bch:byt>
#> 1 sqrt(x)    583.94ns  1.19µs  1.1µs  32.4µs   837483.      848B
#> 2 x^0.5        8.99µs 10.18µs 9.42µs   660µs    98284.      848B
...
#> 1 sqrt(x)    583.94ns    1.1µs   837483.     0
#> 2 x^0.5        8.99µs   9.42µs    98284.     0
```
