...
#> 1 sqrt(x)    586.03ns 802ns 674.04ns 32.7µs  1247026.      848B     0
#> 2 x^0.5        8.96µs  10µs   9.42µs 90.8µs    99637.      848B     0
...
#> 1 sqrt(x)    586.03ns 674.04ns  1247026.     0
#> 2 x^0.5        8.96µs   9.42µs    99637.     0
```
