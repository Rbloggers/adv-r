...
#>   <chr>      <bch> <bch> <bch:tm> <bch:>     <dbl> <bch:byt> <dbl>
#> 1 sqrt(x)    592ns 792ns 657.63ns 39.2µs  1262335.      848B     0
#> 2 x^0.5        9µs  10µs   9.43µs   92µs    99991.      848B     0
...
#> 1 sqrt(x)       592ns 657.63ns  1262335.     0
#> 2 x^0.5           9µs   9.43µs    99991.     0
```
