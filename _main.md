...
#> █ [1:0x49f0838] <chr> 
#> ├─[2:0x1ab3758] <string: "a"> 
#> ├─[2:0x1ab3758] 
#> ├─[3:0x366d518] <string: "abc"> 
#> └─[4:0x1f69af0] <string: "d">
```
...
#> Ncells  682266 36.5    1286171 68.7  1286171 68.7
#> Vcells 4696163 35.9   11787939 90.0 11786962 90.0
```
...
<img src="diagrams/environments/binding.png" width="178" style="display: block; margin: auto;" />
...
<img src="diagrams/environments/execution.png" width="253" style="display: block; margin: auto;" />
...
plus_one
#> function(y) x + y
#> <environment: 0x5b5fae8>
```

<img src="diagrams/environments/closure.png" width="162" style="display: block; margin: auto;" />
...
<img src="diagrams/environments/closure-call.png" width="162" style="display: block; margin: auto;" />
...
#> <bytecode: 0x5f90bf8>
#> <environment: 0x5172aa8>
plot_dev("png")
#> function(...) grDevices::png(..., res = dpi, units = "in")
#> <bytecode: 0x63358a8>
#> <environment: 0x6920210>
```
...
#> 4 mean    4     TRUE    base               
#> 5 mean    5     TRUE    base               
#> 6 mean    6     FALSE   registered S3method
...
#> 1 sqrt(x)    588.01ns 1.19µs  1.1µs 23.8µs   840776.      848B     0 10000
#> 2 x^0.5        8.72µs 9.91µs 9.46µs 45.8µs   100902.      848B     0 10000
...
#> 1 sqrt(x)    588.01ns    1.1µs   840776.     0
#> 2 x^0.5        8.72µs   9.46µs   100902.     0
```
...
#>   expression      min   median `itr/sec`  n_gc
#>   <chr>      <bch:tm> <bch:tm>     <dbl> <dbl>
#> 1 mean1(x)      226µs    229µs     4287.     0
#> 2 mean2(x)      112µs    113µs     8600.     0
```
...
#>   expression           min   median `itr/sec`  n_gc
#>   <chr>           <bch:tm> <bch:tm>     <dbl> <dbl>
#> 1 mean(x)           2.61µs   3.01µs   287619.     1
#> 2 mean.default(x)   1.24µs    1.4µs   654738.     0
```
...
#>   expression              min   median `itr/sec`  n_gc
#>   <chr>              <bch:tm> <bch:tm>     <dbl> <dbl>
#> 1 mean(x)              2.61µs   2.98µs   293690.     1
#> 2 mean.default(x)      1.23µs   1.44µs   635011.     0
#> 3 .Internal(mean(x)) 337.02ns 347.03ns  2588450.     0
```
...
#>   expression              min   median `itr/sec`  n_gc
#>   <chr>              <bch:tm> <bch:tm>     <dbl> <dbl>
#> 1 mean(x)              24.8µs   25.2µs    38545.     1
#> 2 mean.default(x)      23.4µs   23.6µs    41425.     0
#> 3 .Internal(mean(x))   21.6µs   22.4µs    43524.     0
```
...
#>   expression         min   median `itr/sec`  n_gc
#>   <chr>         <bch:tm> <bch:tm>     <dbl> <dbl>
#> 1 as.data.frame   1.03ms   1.09ms      907.     7
#> 2 quick_df        6.11µs   7.15µs   125683.     2
```
...
#>   expression        min   median `itr/sec`  n_gc
#>   <chr>        <bch:tm> <bch:tm>     <dbl> <dbl>
#> 1 lookup[x1]   492.09ns 545.06ns  1582401.     0
#> 2 lookup[x10]    1.54µs   1.67µs   527178.     0
#> 3 lookup[x100]   4.32µs    5.1µs   179620.     0
```
...
#>   expression      min   median `itr/sec`  n_gc
#>   <chr>      <bch:tm> <bch:tm>     <dbl> <dbl>
#> 1 loop10      19.66µs  21.58µs    45007.     2
#> 2 loop100    797.34µs 820.76µs     1206.     2
#> 3 vec10        4.87µs   5.12µs   185924.     0
#> 4 vec100      38.19µs  40.25µs    24131.     0
```
