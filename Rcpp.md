...
add
#> function (x, y, z) 
#> .Call(<pointer: 0x7f00aed69f60>, x, y, z)
add(1, 2, 3)
#> [1] 6
```
...
#> 1 sum(x)       1.31µs   1.53µs   1.34µs 118.83µs   651742.
#> 2 sumC(x)      3.29µs   4.79µs   4.75µs   1.14ms   208642.
#> 3 sumR(x)     38.34µs  40.54µs  39.01µs   3.23ms    24665.
```
...
#>   expression          min     mean   median      max `itr/sec`
#>   <chr>          <bch:tm> <bch:tm> <bch:tm> <bch:tm>     <dbl>
#> 1 pdistR(0.5, y)  10.14ms  10.59ms  10.56ms  13.34ms      94.4
#> 2 pdistC(0.5, y)   5.54ms   6.33ms   6.42ms   7.79ms     158.
```
...
#> 1 gibbs_r(1…   5.95ms   6.22ms   6.14ms 7.17ms      161.    4.97MB
#> 2 gibbs_cpp… 308.26µs 374.02µs 366.13µs 4.33ms     2674.     4.1KB
...
#> 1 vacc1        2.18ms   2.49ms   2.45ms   3.5ms      402.    7.86KB
#> 2 vacc2      105.54µs  159.1µs 121.19µs 645.8µs     6285.  223.98KB
#> 3 vacc3       29.63µs  37.46µs   31.3µs 364.2µs    26696.   14.48KB
#> # … with 3 more variables: n_gc <dbl>, n_itr <int>,
#> #   total_time <bch:tm>
```
