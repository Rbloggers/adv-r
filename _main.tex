...
\CommentTok{#>   expression         min   median `itr/sec`  n_gc}
\CommentTok{#>   <chr>         <bch:tm> <bch:tm>     <dbl> <dbl>}
\CommentTok{#> 1 as.data.frame   1.09ms   1.17ms      831.     7}
\CommentTok{#> 2 quick_df        6.19µs   7.49µs   117156.     1}
\end{Highlighting}
\end{Shaded}
