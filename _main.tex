...
\CommentTok{#>   expression         min   median `itr/sec`  n_gc}
\CommentTok{#>   <chr>         <bch:tm> <bch:tm>     <dbl> <dbl>}
\CommentTok{#> 1 as.data.frame   1.04ms   1.09ms      902.     7}
\CommentTok{#> 2 quick_df        6.06µs   7.04µs   127948.     2}
\end{Highlighting}
\end{Shaded}
