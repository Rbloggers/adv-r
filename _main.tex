...
The base equivalent to \texttt{parse\_exprs()} is \texttt{parse()}. It is a little harder to use because it's specialised for parsing R code stored in files. You need to supply your string to the \texttt{text} argument and it returns an expression vector (Section \ref{expression-vectors}). I recommend turning the output into a list:
...
\CommentTok{#> \}}
\CommentTok{#> <environment: 0x4a57ed0>}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 1 sqrt(x)    592.09ns 802.3ns 683.01ns  37.2µs  1246377.      848B}
\CommentTok{#> 2 x^0.5        8.99µs  10.2µs   9.44µs 756.1µs    98306.      848B}
...
\CommentTok{#> 1 sqrt(x)    592.09ns 683.01ns  1246377.     0}
\CommentTok{#> 2 x^0.5        8.99µs   9.44µs    98306.     0}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   expression      min   median `itr/sec`  n_gc}
\CommentTok{#>   <chr>      <bch:tm> <bch:tm>     <dbl> <dbl>}
\CommentTok{#> 1 mean1(x)      226µs    235µs     4230.     0}
\CommentTok{#> 2 mean2(x)      112µs    113µs     8507.     0}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   expression           min   median `itr/sec`  n_gc}
\CommentTok{#>   <chr>           <bch:tm> <bch:tm>     <dbl> <dbl>}
\CommentTok{#> 1 mean(x)           2.71µs   3.11µs   288770.     1}
\CommentTok{#> 2 mean.default(x)   1.27µs   1.47µs   609222.     0}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   expression              min   median `itr/sec`  n_gc}
\CommentTok{#>   <chr>              <bch:tm> <bch:tm>     <dbl> <dbl>}
\CommentTok{#> 1 mean(x)              2.71µs   3.06µs   288883.     1}
\CommentTok{#> 2 mean.default(x)      1.28µs    1.5µs   583260.     0}
\CommentTok{#> 3 .Internal(mean(x)) 339.93ns 358.91ns  2557222.     0}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   expression              min   median `itr/sec`  n_gc}
\CommentTok{#>   <chr>              <bch:tm> <bch:tm>     <dbl> <dbl>}
\CommentTok{#> 1 mean(x)              24.9µs   25.3µs    37907.     1}
\CommentTok{#> 2 mean.default(x)      23.4µs   23.7µs    40451.     0}
\CommentTok{#> 3 .Internal(mean(x))   22.4µs   22.4µs    43381.     0}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   expression         min   median `itr/sec`  n_gc}
\CommentTok{#>   <chr>         <bch:tm> <bch:tm>     <dbl> <dbl>}
\CommentTok{#> 1 as.data.frame   1.14ms    1.2ms      826.     7}
\CommentTok{#> 2 quick_df        6.47µs   7.65µs   116782.     1}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   expression        min   median `itr/sec`  n_gc}
\CommentTok{#>   <chr>        <bch:tm> <bch:tm>     <dbl> <dbl>}
\CommentTok{#> 1 lookup[x1]   497.91ns 571.48ns  1513221.     0}
\CommentTok{#> 2 lookup[x10]    1.54µs   1.67µs   507373.     0}
\CommentTok{#> 3 lookup[x100]   4.18µs   5.76µs   163573.     0}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   expression      min   median `itr/sec`  n_gc}
\CommentTok{#>   <chr>      <bch:tm> <bch:tm>     <dbl> <dbl>}
\CommentTok{#> 1 loop10      21.39µs  23.43µs    40279.     3}
\CommentTok{#> 2 loop100    817.24µs 850.66µs     1162.     1}
\CommentTok{#> 3 vec10        5.04µs   5.27µs   180120.     1}
\CommentTok{#> 4 vec100      39.51µs   40.3µs    23855.     0}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> .Call(<pointer: 0x7fdebaf22f60>, x, y, z)}
...
\CommentTok{#> 1 sum(x)        1.3µs    1.5µs   1.32µs   73.9µs   669068.}
\CommentTok{#> 2 sumC(x)      3.27µs   4.74µs   4.79µs    1.1ms   210793.}
\CommentTok{#> 3 sumR(x)     38.21µs  40.62µs  39.04µs  214.8µs    24620.}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   expression          min     mean   median      max `itr/sec`}
\CommentTok{#>   <chr>          <bch:tm> <bch:tm> <bch:tm> <bch:tm>     <dbl>}
\CommentTok{#> 1 pdistR(0.5, y)    8.6ms   8.87ms   8.79ms     11ms      113.}
\CommentTok{#> 2 pdistC(0.5, y)   4.74ms   4.83ms    4.8ms      6ms      207.}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 1 gibbs_r(1…   5.65ms   6ms   5.84ms 9.91ms      167.    4.97MB    12}
\CommentTok{#> 2 gibbs_cpp… 309.64µs 356µs 347.93µs 1.47ms     2810.     4.1KB     8}
...
\CommentTok{#>   expression     min    mean   median      max `itr/sec` mem_alloc}
\CommentTok{#>   <chr>      <bch:t> <bch:t> <bch:tm> <bch:tm>     <dbl> <bch:byt>}
\CommentTok{#> 1 vacc1       1.85ms     2ms   1.97ms   2.57ms      500.    7.86KB}
\CommentTok{#> 2 vacc2      99.75µs 124.2µs 110.66µs   3.96ms     8051.  223.98KB}
\CommentTok{#> 3 vacc3      29.06µs  32.1µs  30.46µs 200.81µs    31167.   14.48KB}
\CommentTok{#> # … with 3 more variables: n_gc <dbl>, n_itr <int>,}
\CommentTok{#> #   total_time <bch:tm>}
\end{Highlighting}
\end{Shaded}
