...
\CommentTok{#>   expression         min   median `itr/sec`  n_gc}
\CommentTok{#>   <chr>         <bch:tm> <bch:tm>     <dbl> <dbl>}
\CommentTok{#> 1 as.data.frame   1.06ms   1.13ms      866.     7}
\CommentTok{#> 2 quick_df        6.14µs   7.28µs   122992.     2}
\end{Highlighting}
\end{Shaded}
