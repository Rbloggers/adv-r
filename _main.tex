...
\CommentTok{#>   expression         min   median `itr/sec`  n_gc}
\CommentTok{#>   <chr>         <bch:tm> <bch:tm>     <dbl> <dbl>}
\CommentTok{#> 1 as.data.frame   1.25ms   1.61ms      584.     5}
\CommentTok{#> 2 quick_df        6.24µs   8.32µs    72468.     1}
\end{Highlighting}
\end{Shaded}
