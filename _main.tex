...
\CommentTok{#> \}}
\CommentTok{#> <environment: 0x526a5d8>}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 1 sqrt(x)    585.92ns 740.9ns 620.03ns  22.5µs  1349755.      848B}
\CommentTok{#> 2 x^0.5        9.03µs  10.1µs   9.44µs 745.8µs    99089.      848B}
...
\CommentTok{#> 1 sqrt(x)    585.92ns 620.03ns  1349755.     0}
\CommentTok{#> 2 x^0.5        9.03µs   9.44µs    99089.     0}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   expression      min   median `itr/sec`  n_gc}
\CommentTok{#>   <chr>      <bch:tm> <bch:tm>     <dbl> <dbl>}
\CommentTok{#> 1 mean1(x)      226µs    232µs     4288.     0}
\CommentTok{#> 2 mean2(x)      112µs    113µs     8598.     0}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   expression           min   median `itr/sec`  n_gc}
\CommentTok{#>   <chr>           <bch:tm> <bch:tm>     <dbl> <dbl>}
\CommentTok{#> 1 mean(x)           2.58µs      3µs   293376.     1}
\CommentTok{#> 2 mean.default(x)   1.22µs   1.42µs   636357.     0}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   expression              min   median `itr/sec`  n_gc}
\CommentTok{#>   <chr>              <bch:tm> <bch:tm>     <dbl> <dbl>}
\CommentTok{#> 1 mean(x)              2.56µs   2.92µs   301966.     1}
\CommentTok{#> 2 mean.default(x)      1.23µs   1.44µs   637912.     0}
\CommentTok{#> 3 .Internal(mean(x)) 338.07ns 352.16ns  2604387.     0}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   expression              min   median `itr/sec`  n_gc}
\CommentTok{#>   <chr>              <bch:tm> <bch:tm>     <dbl> <dbl>}
\CommentTok{#> 1 mean(x)              24.8µs   25.2µs    38690.     1}
\CommentTok{#> 2 mean.default(x)      23.4µs   23.6µs    41457.     0}
\CommentTok{#> 3 .Internal(mean(x))   22.4µs   22.4µs    43542.     0}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   expression         min   median `itr/sec`  n_gc}
\CommentTok{#>   <chr>         <bch:tm> <bch:tm>     <dbl> <dbl>}
\CommentTok{#> 1 as.data.frame   1.05ms   1.11ms      877.     7}
\CommentTok{#> 2 quick_df        6.15µs   7.36µs   122097.     2}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   expression        min   median `itr/sec`  n_gc}
\CommentTok{#>   <chr>        <bch:tm> <bch:tm>     <dbl> <dbl>}
\CommentTok{#> 1 lookup[x1]   503.15ns 599.07ns  1541776.     0}
\CommentTok{#> 2 lookup[x10]    1.53µs    1.7µs   505659.     1}
\CommentTok{#> 3 lookup[x100]   4.12µs   4.74µs   194377.     0}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   expression      min   median `itr/sec`  n_gc}
\CommentTok{#>   <chr>      <bch:tm> <bch:tm>     <dbl> <dbl>}
\CommentTok{#> 1 loop10      19.76µs  21.81µs    44236.     3}
\CommentTok{#> 2 loop100    798.34µs 818.24µs     1208.     2}
\CommentTok{#> 3 vec10        4.88µs   5.12µs   186470.     0}
\CommentTok{#> 4 vec100      39.05µs  40.26µs    24015.     0}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> .Call(<pointer: 0x7f4cf3546f60>, x, y, z)}
...
\CommentTok{#> 1 sum(x)       1.31µs    1.5µs   1.34µs  82.39µs   667838.}
\CommentTok{#> 2 sumC(x)      3.26µs   4.53µs   4.73µs   1.02ms   220900.}
\CommentTok{#> 3 sumR(x)     38.86µs  40.69µs  39.44µs 100.97µs    24579.}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   expression          min     mean   median      max `itr/sec`}
\CommentTok{#>   <chr>          <bch:tm> <bch:tm> <bch:tm> <bch:tm>     <dbl>}
\CommentTok{#> 1 pdistR(0.5, y)   8.43ms   8.66ms   8.57ms  11.84ms      115.}
\CommentTok{#> 2 pdistC(0.5, y)   4.47ms   4.75ms   4.74ms   5.93ms      210.}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 1 gibbs_r(1…   5.6ms   5.81ms   5.73ms 6.82ms      172.    4.97MB}
\CommentTok{#> 2 gibbs_cpp…   302µs 348.11µs 341.45µs 1.54ms     2873.     4.1KB}
\CommentTok{#> # … with 3 more variables: n_gc <dbl>, n_itr <int>,}
\CommentTok{#> #   total_time <bch:tm>}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 1 vacc1        1.91ms   2.01ms   1.99ms   2.38ms      498.    7.86KB}
\CommentTok{#> 2 vacc2      103.26µs 119.98µs 111.41µs  339.4µs     8334.  223.98KB}
\CommentTok{#> 3 vacc3       29.24µs  31.48µs   30.3µs 722.96µs    31771.   14.48KB}
\CommentTok{#> # … with 3 more variables: n_gc <dbl>, n_itr <int>,}
\CommentTok{#> #   total_time <bch:tm>}
\end{Highlighting}
\end{Shaded}
