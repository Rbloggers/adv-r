...
* Section \@ref(existing-fos) introduces you to two useful extremely existing 
  FOs, and show you how use them to solve real problems.
  
* Section \@ref(fo-case-study) works through a case study where work through
